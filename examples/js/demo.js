...
$(document).ready(function () {
  ...
  var showColorsForImage = function($image, $imageSection ) {
    ...
    var paletteAndWeight         = colorThief.getPaletteAndWeight(image);
    var elapsedTimeForGetPaletteAndWeight = Date.now() - start + elapsedTimeForGetPalette;

    var colorThiefOutput = {
      color: color,
      palette: palette,
      paletteAndWeight:paletteAndWeight,
      elapsedTimeForGetColor: elapsedTimeForGetColor,
      elapsedTimeForGetPalette: elapsedTimeForGetPalette,
      elapsedTimeForGetPaletteAndWeight:elapsedTimeForGetPaletteAndWeight
    };
